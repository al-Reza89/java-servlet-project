<!-- component -->
<nav
	class=" bg-[#2e1941]  text-white w-full flex relative justify-between items-center mx-auto px-8 h-20">
	<!-- logo -->
	<div class="inline-flex">
		<a class="_o6689fn" href="home.jsp"><div
				class="hidden md:block text-3xl font-bold ">ClassRoom</div> </a>
	</div>
		...
		<div class="inline-block">
			<div class="inline-flex items-center max-w-full">
				<button
					...
					type="button">
					<div class="block flex-grow flex-shrink overflow-hidden">Start
						your search</div>
					<div
 ...
 <%
				String localEmail = (String) session.getAttribute("localEmail");
		...
		<div class="flex justify-end items-center relative">
			...
			<div class="flex mr-4 items-center gap-2 ">
				...
				<div class="block relative">
					<button type="button"
						class="inline-block py-2 px-3 	 hover:bg-[#452767] rounded-full relative ">
				...
				<a
					class="inline-block py-2 px-3 bg-[#452767] hover:bg-[#6115b1] rounded-full"
					href="register.jsp">
					<div
						class="flex items-center relative cursor-pointer whitespace-nowrap">Register</div>
				</a> <a
					class="inline-block py-2 px-3 bg-[#452767] hover:bg-[#6115b1] rounded-full"
					href="signIn.jsp">
					<div
						class="flex items-center relative cursor-pointer whitespace-nowrap">Sign
						In</div>
				</a>
			</div>
		...
		<div class="flex justify-end items-center relative">
			...
			<div class="flex mr-4 items-center gap-2 ">
				...
				<button
					...
					href="register.jsp">
					<div
						class="flex items-center relative cursor-pointer whitespace-nowrap">Logout</div>
				</button> 
